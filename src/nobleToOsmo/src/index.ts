...
export const convertNobleToOsmo = async (mnemonic: string, amount: string, nobleRPC: string, channel: string, reciepentAddress: string): Promise<string | null> => {
  ...
  try {
    const txHash = (await signer.sendIbcTokens(
      ...
      { amount: [coin("2000000", "uusdc")], gas: "20000000" }
    )).transactionHash
    // console.log(txHash)
    return txHash
  } catch (error) {
  ...
  // const tokenIn = coin("100000" , "ibc/DE6792CF9E521F6AD6E9A4BDF6225C9571A3B74ACC0A529F92BC5122A39D2E58")
  // const tokenOut = coin("100000" ,  "ibc/AD59D59CFB0E628E73C798415F823AB5B6257C2FE4BF67DBB5D6A677B2686E82")
  // const tokenInAmount = "100000";
  // const tokenOutAmount= "100000";
